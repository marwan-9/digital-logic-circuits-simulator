...
public:
	...
	// void setSourcePin(OutputPin* r_SrcPin);
	// void setDestPin(InputPin* r_DstPin);
	// OutputPin* getSourcePin();
	// InputPin* getDestPin();

	void setSourcePin(Component* r_SrcCmpnt);
	void setDestPin(Component* r_DstCmpnt);
	Component* getSourcePin();
	Component* getDestPin();
